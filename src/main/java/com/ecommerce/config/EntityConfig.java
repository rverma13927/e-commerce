...
@Configuration
@EnableJpaRepositories(basePackages = "com.ecommerce", transactionManagerRef = "jpaTransactionManager")
@PropertySource(value = { "classpath:application.properties" })
@EnableTransactionManagement
class EntityConfig {
    private static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = { "com.ecommerce" };
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPersistenceUnitName("E-commerce");
